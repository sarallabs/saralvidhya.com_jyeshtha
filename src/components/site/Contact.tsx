          ...
          <div className="info-cards" style={{ marginBottom: '20px', gap: '16px' }}>
            ...
            <div className="info-card" style={{ padding: '20px' }}>
              ...
              <div className="card-text">
                ...
                <span className="card-value" style={{ fontSize: '0.9rem' }}>
                  <a href="tel:04045694188">040-45694188</a>
                </span>
              </div>
            </div>
            ...
            <div className="info-card" style={{ gridColumn: '1 / -1', maxWidth: '100%', padding: '20px' }}>
              ...
              <div className="card-text">
                ...
                <span className="card-value" style={{ fontSize: '0.9rem' }}>Road Number 36, Jubilee Hills, Hyderabad - 500033</span>
              </div>
            </div>
          </div>
              ...
              <div className="office-strip">
                ...
                <div className="office-cards">
                  <div className="office-card">
                    ...
                    <p className="office-addr">Road Number 36<br />Jubilee Hills, Hyderabad<br />Telangana — 500033</p>
                  </div>
